...
const FEED_URL = 'https://feeds.bloomberg.com/news.rss';
...
cli({
  ...
  browser: false,
  args: [
    { name: 'limit', type: 'int', default: 15, help: 'Number of feed items to return (max 30)' },
  ],
  columns: ['rank', 'title', 'time', 'url', 'summary'],
  func: async (_page, kwargs) => {
    const count = Math.max(1, Math.min(Number(kwargs.limit) || 15, 30));
